...
kps.rotations.register("PRIEST","SHADOW",{
    ...
    {spells.shadowfiend, 'not player.hasTalent(6,3) and player.hasBuff(spells.voidform) and player.buffStacks(spells.voidform) > 24 and player.insanity < 80' , "target" },
    {spells.mindbender, 'player.hasTalent(6,3) and player.hasBuff(spells.voidform) and player.buffStacks(spells.voidform) > 24 and player.insanity < 80' , "target" },
    ...
    -- "Dispersion" 47585    
    {spells.dispersion, 'player.hasBuff(spells.voidform) and player.buffStacks(spells.voidform) > 39 and spells.mindbender.cooldown > 44' , "DISPERSION_BUFF" },
