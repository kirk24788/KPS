...
kps.rotations.register("WARRIOR","FURY",
{
    ...
    -- Cooldowns
    {{"nested"}, 'kps.cooldowns and spells.battleCry.cooldown == 0', {
        {spells.dragonRoar},
        {spells.avatar},
        {spells.battleCry , 'true', "target" , "BATTLECRY" }, -- 60 sec cd
        {spells.bloodthirst},
        {spells.rampage, 'player.hasBuff(spells.battleCry)' },
        {spells.odynsFury}, -- 45 sec cd
        {spells.ragingBlow},
    }},
    ...
    {{"nested"}, 'kps.multitarget', {
        ...
        {spells.rampage, 'not player.hasBuff(spells.enrage)' },
        {spells.rampage, 'player.rage == 100 and player.hasBuff(spells.meatCleaver)' },
        {spells.bloodthirst, 'not player.hasBuff(spells.enrage) and player.hasBuff(spells.meatCleaver)' },
        {spells.whirlwind, 'player.hasBuff(spells.wreckingBall)' },
        {spells.ragingBlow},
        {spells.whirlwind},
    }},
