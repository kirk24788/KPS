...
kps.rotations.register("PALADIN","RETRIBUTION",
{
    ...
    {{"nested"}, 'activeEnemies.count >= 3', { -- call_action_list,name=cleave,if=active_enemies>=3
        {spells.finalVerdict, 'not player.hasBuff(spells.finalVerdict) and player.holyPower == 5'}, -- final_verdict,if=buff.final_verdict.down&holy_power=5
        ...
        {spells.exorcism, 'player.hasBuff(spells.blazingContempt) and player.holyPower <= 2 and not player.hasBuff(spells.holyAvenger)'}, -- exorcism,if=buff.blazing_contempt.up&holy_power<=2&buff.holy_avenger.down
        ...
        {spells.finalVerdict, 'not player.hasBuff(spells.finalVerdict) and ( player.hasBuff(spells.avengingWrath) or target.hp < 35 )'}, -- final_verdict,if=buff.final_verdict.down&(buff.avenging_wrath.up|target.health.pct<35)
        ...
        {spells.hammerOfTheRighteous, 'activeEnemies.count >= 4 and player.holyPower < 5 and player.hasTalent(7, 2)'}, -- hammer_of_the_righteous,if=active_enemies>=4&holy_power<5&talent.seraphim.enabled
        {spells.hammerOfTheRighteous, 'activeEnemies.count >= 4 and ( player.holyPower <= 3 or ( player.holyPower == 4 and target.hp >= 35 and not player.hasBuff(spells.avengingWrath) ) )'}, -- hammer_of_the_righteous,if=active_enemies>=4&(holy_power<=3|(holy_power=4&target.health.pct>=35&buff.avenging_wrath.down))
        ...
        {spells.crusaderStrike, 'player.holyPower <= 3 or ( player.holyPower == 4 and target.hp >= 35 and not player.hasBuff(spells.avengingWrath) )'}, -- crusader_strike,if=holy_power<=3|(holy_power=4&target.health.pct>=35&buff.avenging_wrath.down)
        ...
        {spells.judgment, 'player.holyPower <= 3 or ( player.holyPower == 4 and spells.crusaderStrike.cooldown >= player.gcd * 2 and target.hp > 35 and not player.hasBuff(spells.avengingWrath) )'}, -- judgment,if=holy_power<=3|(holy_power=4&cooldown.crusader_strike.remains>=gcd*2&target.health.pct>35&buff.avenging_wrath.down)
        ...
        {spells.finalVerdict, 'player.buffStacks(spells.divinePurpose) and not player.hasBuff(spells.finalVerdict)'}, -- final_verdict,if=buff.divine_purpose.react&buff.final_verdict.down
        {spells.finalVerdict, 'player.holyPower >= 4 and not player.hasBuff(spells.finalVerdict)'}, -- final_verdict,if=holy_power>=4&buff.final_verdict.down
        ...
        {spells.finalVerdict, 'player.holyPower >= 3 and not player.hasBuff(spells.finalVerdict)'}, -- final_verdict,if=holy_power>=3&buff.final_verdict.down
    ...
    {{"nested"}, 'True', { -- call_action_list,name=single
        ...
        {spells.divineStorm, 'player.buffStacks(spells.divineCrusader) and ( player.holyPower == 5 or player.hasBuff(spells.holyAvenger) and player.holyPower >= 3 ) and activeEnemies.count == 2 and not player.hasTalent(7, 3)'}, -- divine_storm,if=buff.divine_crusader.react&(holy_power=5|buff.holy_avenger.up&holy_power>=3)&active_enemies=2&!talent.final_verdict.enabled
        {spells.divineStorm, '( player.holyPower == 5 or player.hasBuff(spells.holyAvenger) and player.holyPower >= 3 ) and activeEnemies.count == 2 and player.hasBuff(spells.finalVerdict)'}, -- divine_storm,if=(holy_power=5|buff.holy_avenger.up&holy_power>=3)&active_enemies=2&buff.final_verdict.up
        ...
        {spells.templarsVerdict, '( player.holyPower == 5 or player.hasBuff(spells.holyAvenger) and player.holyPower >= 3 ) and ( not player.hasBuff(spells.avengingWrath) or target.hp > 35 ) and ( not player.hasTalent(7, 2) or spells.seraphim.cooldown > player.gcd * 4 )'}, -- templars_verdict,if=(holy_power=5|buff.holy_avenger.up&holy_power>=3)&(buff.avenging_wrath.down|target.health.pct>35)&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*4)
        ...
        {spells.exorcism, 'player.hasBuff(spells.blazingContempt) and player.holyPower <= 2 and not player.hasBuff(spells.holyAvenger)'}, -- exorcism,if=buff.blazing_contempt.up&holy_power<=2&buff.holy_avenger.down
        {spells.sealOfTruth, 'player.hasTalent(7, 1) and not player.hasBuff(spells.maraadsTruth)'}, -- seal_of_truth,if=talent.empowered_seals.enabled&buff.maraads_truth.down
        ...
        {spells.sealOfRighteousness, 'player.hasTalent(7, 1) and player.buffDuration(spells.maraadsTruth) > spells.judgment.cooldownTotal and not player.hasBuff(spells.liadrinsRighteousness) and not player.hasBuff(spells.avengingWrath) and not player.bloodlust'}, -- seal_of_righteousness,if=talent.empowered_seals.enabled&buff.maraads_truth.remains>cooldown.judgment.duration&buff.liadrins_righteousness.down&!buff.avenging_wrath.up&!buff.bloodlust.up
        {spells.divineStorm, 'player.buffStacks(spells.divineCrusader) and player.hasBuff(spells.finalVerdict) and ( player.hasBuff(spells.avengingWrath) or target.hp < 35 )'}, -- divine_storm,if=buff.divine_crusader.react&buff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)
        {spells.divineStorm, 'activeEnemies.count == 2 and player.hasBuff(spells.finalVerdict) and ( player.hasBuff(spells.avengingWrath) or target.hp < 35 )'}, -- divine_storm,if=active_enemies=2&buff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)
        ...
        {spells.divineStorm, 'player.buffStacks(spells.divineCrusader) and activeEnemies.count == 2 and ( player.hasBuff(spells.avengingWrath) or target.hp < 35 ) and not player.hasTalent(7, 3)'}, -- divine_storm,if=buff.divine_crusader.react&active_enemies=2&(buff.avenging_wrath.up|target.health.pct<35)&!talent.final_verdict.enabled
...
-- ERROR in 'judgment,cycle_targets=1,if=last_judgment_target!=target&glyph.double_jeopardy.enabled&holy_power<5': Unknown expression 'last_judgment_target'!
        {spells.exorcism, 'player.hasGlyph(spells.glyphOfMassExorcism) and activeEnemies.count >= 2 and player.holyPower < 5 and not player.hasGlyph(spells.glyphOfDoubleJeopardy) and = 1'}, -- exorcism,if=glyph.mass_exorcism.enabled&active_enemies>=2&holy_power<5&!glyph.double_jeopardy.enabled&!set_bonus.tier17_4pc=1
        {spells.judgment, 'player.holyPower < 5 and player.hasTalent(7, 2)'}, -- judgment,if=holy_power<5&talent.seraphim.enabled
        {spells.judgment, 'player.holyPower <= 3 or ( player.holyPower == 4 and spells.crusaderStrike.cooldown >= player.gcd * 2 and target.hp > 35 and not player.hasBuff(spells.avengingWrath) )'}, -- judgment,if=holy_power<=3|(holy_power=4&cooldown.crusader_strike.remains>=gcd*2&target.health.pct>35&buff.avenging_wrath.down)
        {spells.divineStorm, 'player.buffStacks(spells.divineCrusader) and player.hasBuff(spells.finalVerdict)'}, -- divine_storm,if=buff.divine_crusader.react&buff.final_verdict.up
        {spells.divineStorm, 'activeEnemies.count == 2 and player.holyPower >= 4 and player.hasBuff(spells.finalVerdict)'}, -- divine_storm,if=active_enemies=2&holy_power>=4&buff.final_verdict.up
        ...
        {spells.divineStorm, 'player.buffStacks(spells.divineCrusader) and activeEnemies.count == 2 and player.holyPower >= 4 and not player.hasTalent(7, 3)'}, -- divine_storm,if=buff.divine_crusader.react&active_enemies=2&holy_power>=4&!talent.final_verdict.enabled
        ...
        {spells.exorcism, 'player.holyPower < 5 and player.hasTalent(7, 2)'}, -- exorcism,if=holy_power<5&talent.seraphim.enabled
        {spells.exorcism, 'player.holyPower <= 3 or ( player.holyPower == 4 and ( spells.judgment.cooldown >= player.gcd * 2 and spells.crusaderStrike.cooldown >= player.gcd * 2 and target.hp > 35 and not player.hasBuff(spells.avengingWrath) ) )'}, -- exorcism,if=holy_power<=3|(holy_power=4&(cooldown.judgment.remains>=gcd*2&cooldown.crusader_strike.remains>=gcd*2&target.health.pct>35&buff.avenging_wrath.down))
        {spells.divineStorm, 'activeEnemies.count == 2 and player.holyPower >= 3 and player.hasBuff(spells.finalVerdict)'}, -- divine_storm,if=active_enemies=2&holy_power>=3&buff.final_verdict.up
