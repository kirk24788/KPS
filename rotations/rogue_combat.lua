...
kps.rotations.register("ROGUE","COMBAT",
{
    ...
    {spells.bladeFlurry, '( activeEnemies.count >= 2 and not player.hasBuff(spells.bladeFlurry) ) or ( activeEnemies.count < 2 and player.hasBuff(spells.bladeFlurry) )'}, -- blade_flurry,if=(active_enemies>=2&!buff.blade_flurry.up)|(active_enemies<2&buff.blade_flurry.up)
