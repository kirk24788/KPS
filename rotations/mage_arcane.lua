...
-- ERROR in 'blazing_speed,if=movement.remains>0': Spell 'blazingSpeed' unknown!
    ...
    {{"nested"}, 'activeEnemies.count >= 5', { -- call_action_list,name=aoe,if=active_enemies>=5
        ...
        {spells.arcaneMissiles, 'activeEnemies.count < 10 and player.buffStacks(spells.arcaneCharge) == 4 and player.buffStacks(spells.arcaneInstability)'}, -- arcane_missiles,if=set_bonus.tier17_4pc&active_enemies<10&buff.arcane_charge.stack=4&buff.arcane_instability.react
...
-- ERROR in 'cone_of_cold,if=glyph.cone_of_cold.enabled': Spell 'kps.spells.mage.glyphOfConeOfCold' unknown (in expression: 'glyph.cone_of_cold.enabled')!
...
-- ERROR in 'call_action_list,name=init_crystal,if=talent.prismatic_crystal.enabled&cooldown.prismatic_crystal.up': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.up')!
...
-- ERROR in 'nether_tempest,if=buff.arcane_charge.stack=4&!ticking&pet.prismatic_crystal.remains>8': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
            {spells.supernova, 'player.mana < 96'}, -- supernova,if=mana.pct<96
-- ERROR in 'presence_of_mind,if=cooldown.cold_snap.up|pet.prismatic_crystal.remains<2*spell_haste': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
-- ERROR in 'arcane_blast,if=buff.arcane_charge.stack=4&mana.pct>93&pet.prismatic_crystal.remains>cast_time': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
-- ERROR in 'arcane_missiles,if=pet.prismatic_crystal.remains>2*spell_haste+travel_time': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
-- ERROR in 'supernova,if=pet.prismatic_crystal.remains<2*spell_haste': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
...
-- ERROR in 'presence_of_mind,if=mana.pct>96&(!talent.prismatic_crystal.enabled|!cooldown.prismatic_crystal.up)': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.up')!
        ...
        {spells.evocation, 'target.timeToDie > 10 and player.mana < 30+2 . 5 * activeEnemies.count * ( 9 - activeEnemies.count ) - ( 40 * ( player.hasBuff(spells.arcanePower) ) )'}, -- evocation,interrupt_if=mana.pct>100-10%spell_haste,if=target.time_to_die>10&mana.pct<30+2.5*active_enemies*(9-active_enemies)-(40*(t18_class_trinket&buff.arcane_power.up))
-- ERROR in 'presence_of_mind,if=!talent.prismatic_crystal.enabled|!cooldown.prismatic_crystal.up': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.up')!
        {spells.arcaneBlast}, -- arcane_blast
    ...
    {{"nested"}, 'True', { -- call_action_list,name=conserve
        ...
        {spells.arcaneMissiles, 'player.buffStacks(spells.arcaneInstability) and player.buffDuration(spells.arcaneInstability) < spells.arcaneBlast.castTime'}, -- arcane_missiles,if=set_bonus.tier17_4pc&buff.arcane_instability.react&buff.arcane_instability.remains<action.arcane_blast.execute_time
        {spells.netherTempest, 'target.npcId = 76933 and player.buffStacks(spells.arcaneCharge) == 4 and ( target.hasMyDebuff(spells.netherTempest) or ( target.hasMyDebuff(spells.netherTempest) and target.myDebuffDuration(spells.netherTempest) < 3.6 ) )'}, -- nether_tempest,cycle_targets=1,if=target!=prismatic_crystal&buff.arcane_charge.stack=4&(active_dot.nether_tempest=0|(ticking&remains<3.6))
-- ERROR in 'supernova,if=target.time_to_die<8|(charges=2&(buff.arcane_power.up|!cooldown.arcane_power.up)&(!talent.prismatic_crystal.enabled|cooldown.prismatic_crystal.remains>8))': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
...
-- ERROR in 'supernova,if=mana.pct<96&(buff.arcane_missiles.stack<2|buff.arcane_charge.stack=4)&(buff.arcane_power.up|(charges=1&cooldown.arcane_power.remains>recharge_time))&(!talent.prismatic_crystal.enabled|current_target=prismatic_crystal|(charges=1&cooldown.prismatic_crystal.remains>recharge_time+8))': Spell 'kps.spells.mage.prismaticCrystal' unknown (in expression: 'cooldown.prismatic_crystal.remains')!
