...
kps.rotations.register("MONK","WINDWALKER",
{
    ...
    {spells.stormEarthAndFire, 'not player.hasBuff(spells.stormEarthAndFire)'}, -- storm_earth_and_fire,target=2,if=debuff.storm_earth_and_fire_target.down
    {spells.stormEarthAndFire, 'not player.hasBuff(spells.stormEarthAndFire)'}, -- storm_earth_and_fire,target=3,if=debuff.storm_earth_and_fire_target.down
    {{"nested"}, 'player.hasTalent(7, 3) and player.hasTalent(3, 3) and spells.fistsOfFury.cooldown == 0 and player.timeInCombat < 20', { -- call_action_list,name=opener,if=talent.serenity.enabled&talent.chi_brew.enabled&cooldown.fists_of_fury.up&time<20
        {spells.tigereyeBrew, 'not player.hasBuff(spells.tigereyeBrew) and player.buffStacks(spells.tigereyeBrew) >= 9'}, -- tigereye_brew,if=buff.tigereye_brew_use.down&buff.tigereye_brew.stack>=9
    ...
    {spells.risingSunKick, '( not player.hasBuff(spells.risingSunKick) or player.buffDuration(spells.risingSunKick) < 3 )'}, -- rising_sun_kick,if=(debuff.rising_sun_kick.down|debuff.rising_sun_kick.remains<3)
    ...
    {{"nested"}, 'activeEnemies.count < 3 and ( player.level < 100 or not player.hasTalent(7, 2) )', { -- call_action_list,name=st,if=active_enemies<3&(level<100|!talent.chi_explosion.enabled)
        ...
        {spells.chiTorpedo, 'player.energyTimeToMax > 2 and not player.hasBuff(spells.serenity)'}, -- chi_torpedo,if=energy.time_to_max>2&buff.serenity.down
...
,"monk_windwalker_1h.simc")

--GENERATED FROM SIMCRAFT PROFILE 'monk_windwalker_2h.simc'
kps.rotations.register("MONK","WINDWALKER",
{
    {spells.invokeXuenTheWhiteTiger}, -- invoke_xuen
    {spells.stormEarthAndFire, 'not player.hasBuff(spells.stormEarthAndFire)'}, -- storm_earth_and_fire,target=2,if=debuff.storm_earth_and_fire_target.down
...
,"monk_windwalker_2h.simc")

--GENERATED FROM SIMCRAFT PROFILE 'monk_windwalker.simc'
kps.rotations.register("MONK","WINDWALKER",
{
-- ERROR in 'invoke_xuen': Spell 'invokeXuenTheWhiteTiger' unknown!
-- ERROR in 'touch_of_death,if=!artifact.gale_burst.enabled': Spell 'touchOfDeath' unknown!
-- ERROR in 'touch_of_death,if=artifact.gale_burst.enabled&cooldown.strike_of_the_windlord.up&!talent.serenity.enabled&cooldown.fists_of_fury.remains<=9&cooldown.rising_sun_kick.remains<=5': Spell 'touchOfDeath' unknown!
-- ERROR in 'touch_of_death,if=artifact.gale_burst.enabled&cooldown.strike_of_the_windlord.up&talent.serenity.enabled&cooldown.fists_of_fury.remains<=3&cooldown.rising_sun_kick.remains<8': Spell 'touchOfDeath' unknown!
-- ERROR in 'storm_earth_and_fire,if=artifact.strike_of_the_windlord.enabled&cooldown.strike_of_the_windlord.up&cooldown.fists_of_fury.remains<=9&cooldown.rising_sun_kick.remains<=5': Spell 'stormEarthAndFire' unknown!
-- ERROR in 'storm_earth_and_fire,if=!artifact.strike_of_the_windlord.enabled&cooldown.fists_of_fury.remains<=9&cooldown.rising_sun_kick.remains<=5': Spell 'stormEarthAndFire' unknown!
-- ERROR in 'serenity,if=artifact.strike_of_the_windlord.enabled&cooldown.strike_of_the_windlord.up&cooldown.fists_of_fury.remains<=3&cooldown.rising_sun_kick.remains<8': Spell 'serenity' unknown!
-- ERROR in 'serenity,if=!artifact.strike_of_the_windlord.enabled&cooldown.fists_of_fury.remains<=3&cooldown.rising_sun_kick.remains<8': Spell 'serenity' unknown!
-- ERROR in 'energizing_elixir,if=energy<energy.max&chi<=1&buff.serenity.down': Spell 'energizingElixir' unknown!
-- ERROR in 'rushing_jade_wind,if=buff.serenity.up&!prev_gcd.rushing_jade_wind': Spell 'rushingJadeWind' unknown!
-- ERROR in 'strike_of_the_windlord,if=artifact.strike_of_the_windlord.enabled': Spell 'strikeOfTheWindlord' unknown!
-- ERROR in 'whirling_dragon_punch': Spell 'whirlingDragonPunch' unknown!
-- ERROR in 'fists_of_fury': Spell 'fistsOfFury' unknown!
