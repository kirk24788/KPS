...
kps.rotations.register("PRIEST","HOLY",{
    ...
    -- "Soins de lien" 32546
    {spells.bindingHeal, 'not player.isMoving and heal.lowestInRaid.hp < 0.70 and player.hp < 0.70 and not and heal.lowestInRaid.isUnit("player")' , kps.heal.lowestInRaid},
    ...
    {spells.prayerOfHealing, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countInRange * 2 >= heal.maxcountInRange' , "player" },
    ...
    -- "Soins rapides" 2060
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hp < 0.50 and heal.lowestTankInRaid.hp > 0.70 ' , kps.heal.lowestInRaid , "FLASHEAL50" },
    ...
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.70' , kps.heal.lowestInRaid , "FLASHEAL70" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.80 and heal.lowestInRaid.incomingDamage > heal.lowestInRaid.incomingHeal' , kps.heal.lowestInRaid , "FLASHEAL80" },
    
    -- "Soins" 2060 -- "Renouveau constant" 200153
    {spells.heal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.80 and heal.lowestInRaid.incomingDamage < heal.lowestInRaid.incomingHeal' , kps.heal.lowestInRaid , "HEAL80" },
    ...
    -- "Renew" 139
    {spells.renew, 'heal.lowestInRaid.hpIncoming < 0.95 and heal.lowestInRaid.myBuffDuration(spells.renew) < 3' , kps.heal.lowestInRaid, "RENEW" },
