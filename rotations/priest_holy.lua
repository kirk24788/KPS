...
kps.rotations.register("PRIEST","HOLY",{
    ...
    {spells.prayerOfHealing, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countInRange * 2 >= heal.maxcountInRange and heal.countInRange > 3 and not player.isInRaid' , "player" },
    {spells.prayerOfHealing, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countInRange * 2 >= heal.maxcountInRange and heal.countInRange > 5 and player.isInRaid' , "player" },
    {spells.holyWordSanctify, 'not player.isMoving and heal.countInRange * 2 >= heal.maxcountInRange and heal.averageHpIncoming < 0.80 and heal.countInRange > 3 and not player.isInRaid' },
    {spells.holyWordSanctify, 'not player.isMoving and heal.countInRange * 2 >= heal.maxcountInRange and heal.averageHpIncoming < 0.80 and heal.countInRange > 5 and player.isInRaid' },
    ...
    {spells.renew, 'heal.countInRange < 3 and heal.lowestInRaid.hpIncoming < 0.95 and heal.lowestInRaid.hp > 0.70 and heal.lowestInRaid.myBuffDuration(spells.renew) < 3' , kps.heal.lowestInRaid, "RENEWCOUNT" },
    -- "Circle of Healing" 204883
    {spells.circleOfHealing, 'player.isMoving and heal.averageHpIncoming < 0.80' , kps.heal.lowestInRaid},
    
    -- "Soins rapides" 2060
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.60 and heal.lowestTankInRaid.hp > heal.lowestInRaid.hp' , kps.heal.lowestInRaid , "FLASHEAL60" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestTankInRaid.hpIncoming < 0.80' , kps.heal.lowestTankInRaid , "FLASHEALTANK" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestTargetInRaid.hpIncoming < 0.80' , kps.heal.lowestTargetInRaid , "FLASHEALTANK" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.60 and player.isInRaid' , kps.heal.lowestInRaid , "FLASHEAL70" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hpIncoming < 0.70 and not player.isInRaid' , kps.heal.lowestInRaid , "FLASHEAL70" },
    ...
    {spells.heal, 'not player.isMoving and holyWordSerenityOnCD()' , kps.heal.lowestInRaid , "HEALSERENITY" },

    -- "Renew" 139
    {spells.renew, 'heal.lowestInRaid.hpIncoming < 0.95 and heal.lowestInRaid.myBuffDuration(spells.renew) < 3' , kps.heal.lowestInRaid, "RENEWLOWEST" },
