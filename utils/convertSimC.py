...
_EXPRESSION_CONVERSIONS = [
    ...
    ("gcd", "player.gcd"),
    ("gcd.max", "player.gcd"),
    ("incoming_damage_1s", "player.incomingDamage"),
    ("incoming_damage_1500ms", "player.incomingDamage"),
    ("incoming_damage_2500ms", "player.incomingDamage"),
    ("incoming_damage_5s", "player.incomingDamage"),
    ("incoming_damage_10s", "player.incomingDamage"),
